namespace L08_Canvas_Alley {
    ...
    function handleLoad(_event: Event): void {
        ...
        let posStreet: Vector = { x: crc2.canvas.width / 2 + randomNumber(-200, 200), y: horizon }; // Fluchtpunkt Straße ändern -> Bäume mitbewegt, da deren Position abhängig von posStreet ist
